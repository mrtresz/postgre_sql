...
-- creting the 2014 library data table
...
FROM 'C:\Users\ASUS\Downloads\practical-sql-main\practical-sql-main\Chapter_08\pls_fy2014_pupld14a.csv'
...
FROM 'C:\Users\ASUS\Downloads\practical-sql-main\practical-sql-main\Chapter_08\pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER);
...
-- aggregation data using grouo by
SELECT stabr
FROM pls_fy2014_pupld14a
GROUP BY stabr
ORDER BY stabr;